...
#sourced and modified from https://github.com/EdjeElectronics/TensorFlow-Lite-Object-Detection-on-Android-and-Raspberry-Pi/blob/master/TFLite_detection_webcam.py
...
#values used for defining movement states on MCU
left = 0
right = 1
turn = 1
no_turn = 0
